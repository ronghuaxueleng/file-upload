...
SWFUpload.prototype.initSettings = function (userSettings) {
	...
	this.ensureDefault("button_height", 35);
	this.ensureDefault("button_text", "<span class='theFont'>上传文件</span>");
	this.ensureDefault("button_text_style", ".theFont {font-size: 12px;font-weight: 600;color: #ffffff;text-align: center;}");
	this.ensureDefault("button_text_top_padding", 10);
...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	...
	return ['<span style="-moz-user-select: none;background-color: #3498db;background-image: none;border-radius: 4px;display: inline-block;margin-bottom: 0;text-align: center;vertical-align: middle;white-space: nowrap;"><object id="', this.movieName, '" type="application/x-shockwave-flash" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
